...
**Usage:**
- `/visual-verdict <baseline> <candidate>` — Compare two screenshots
- `/visual-verdict run` — Run all visual tests
- `/visual-verdict approve <test>` — Approve new baseline

**Examples:**
- `/visual-verdict screenshots/v1/login.png screenshots/v2/login.png`
- `/visual-verdict run`
- `/visual-verdict approve dashboard-dark-mode`
...
- Run /visual-verdict approve if acceptable
```
...
| Command | Description |
|---------|-------------|
| `/visual-verdict baseline <path>` | Register baseline |
| `/visual-verdict compare <a> <b>` | Compare two images |
| `/visual-verdict run` | Run visual test suite |
| `/visual-verdict approve <name>` | Accept as new baseline |
| `/visual-verdict list` | Show registered baselines |
