...
WHILE consensus NOT reached:
  1. planner: Draft plan with approach + timeline
  2. architect: Review for technical soundness
  3. critic: Identify risks, edge cases, alternatives
...
| Agent | Model | Role |
|-------|-------|------|
| `planner` | opus | Drafts approach and sequencing |
| `architect` | opus | Reviews technical feasibility |
| `critic` | opus | Identifies risks and alternatives |
