...
**Usage:** `/ultrawork <task>`

**Examples:**
- `/ultrawork implement all five API endpoints in parallel`
- `/ultrawork write tests for services: auth, billing, notifications`
