...
| Agent | Model | Role |
|-------|-------|------|
| `explorer` | haiku4.5 | Codebase search and mapping |
| `planner` | claude-opus-4-7 | Task planning and sequencing |
| `executor` | sonnet4.6 | Code implementation |
| `architect` | claude-opus-4-7 | Architecture and verification |
