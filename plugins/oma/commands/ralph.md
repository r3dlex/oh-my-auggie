...
**Examples:**
- `/ralph fix all null pointer exceptions in src/auth/`
- `/ralph implement the complete user registration flow`
...
Run `/cancel` to stop the persistence loop and clear state.
