...
const eventSeqBySession = new Map<string, number>();
...
export function buildHookEvent(input: HookEventInput): SuperOmaEvent {
...
export function emitHookEvent(input: HookEventInput): void {
