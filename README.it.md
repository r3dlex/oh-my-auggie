...
**Orchestrazione multi-agente per la CLI auggie di Augment Code. Nessuna curva di apprendimento.**

_Non imparare la CLI auggie di Augment Code. Usa semplicemente oma._

> Questo README localizzato segue il modello OMA unificato. I comandi restano invariati per essere copiati direttamente.
